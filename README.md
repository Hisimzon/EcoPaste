...
>本仓库基于原作者的[EcoPaste](https://github.com/EcoPasteHub/EcoPaste) 项目进行维护，由于本人并不熟悉 Rust 语言，相关 Bug 修复与功能完善均在 AI 辅助下完成。所有修改仅针对 Windows 平台，且以个人使用为目的，未经过充分测试，不保证稳定性与兼容性。感谢原作者的开源贡献！
